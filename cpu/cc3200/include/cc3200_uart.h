 ...
 * based on the cc2538_uart_t definitions (UART reg memory layout is shared between cc3200 and cc2538)
 * @{
 */
     ...
     */
        union {
            ...
            struct
            {
                cc3200_reg_t TXIFLSEL : 3;  /**< UART transmit interrupt FIFO level select */
                cc3200_reg_t RXIFLSEL : 3;  /**< UART receive interrupt FIFO level select */
     ...
     */
        union {
            ...
            struct
            {
                ...
                cc3200_reg_t RTMIS : 1;       /**< UART receive time-out masked interrupt status */
                cc3200_reg_t FEMIS : 1;       /**< UART framing error masked interrupt status */
                cc3200_reg_t PEMIS : 1;       /**< UART parity error masked interrupt status */
                cc3200_reg_t BEMIS : 1;       /**< UART break error masked interrupt status */
                cc3200_reg_t OEMIS : 1;       /**< UART overrun error masked interrupt status */
                cc3200_reg_t RESERVED9 : 1;   /**< Reserved bits */
                cc3200_reg_t NINEBITMIS : 1;  /**< 9-bit mode masked interrupt status */
                cc3200_reg_t LMSBMIS : 1;     /**< LIN mode sync break masked interrupt status */
                cc3200_reg_t LME1MIS : 1;     /**< LIN mode edge 1 masked interrupt status */
                cc3200_reg_t LME5MIS : 1;     /**< LIN mode edge 5 masked interrupt status */
